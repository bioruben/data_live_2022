...
if __name__ == '__main__':
	...
	parser.add_argument('-n', '--nameModel', default="modelTrain_backup.h5", help="Name of the trained model for detection")
	...
	if (prediction < 0.5):
		print("\n\n\n*************************")
		print("Luke Skywalker - ", 1 - prediction)
		print("*************************")
	else:
		print("\n\n\n*************************")
		print("Darth Vader - ", prediction)
		print("*************************")